using Timesheet.Shared.Infrastructure.Logging.Options;
using FileOptions = Timesheet.Shared.Infrastructure.Logging.Options.FileOptions;

namespace Timesheet.Shared.Infrastructure.Logging;
