            ...
            .AddJwtBearer(o =>
            {
                ...
                o.Events = new JwtBearerEvents
                {
                    ...
                    OnTokenValidated = async context =>
                    {
                        ...
                        var uniqueIdentifier = context.Principal!.Claims.First(e => e.Type == "uir");

                        var claims =
                            await cache.GetAsync<Dictionary<string, IEnumerable<string>>>(uniqueIdentifier.Value);
                        ...
                        foreach (var (claim, values) in claims)
                            ((ClaimsIdentity)context.Principal.Identity!).AddClaims(values.Select(value =>
